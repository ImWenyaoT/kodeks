...
| --- | --- | --- |
| Responses API | `src/kodeks/providers/responses_adapter.py`, `src/kodeks/responses_tool_loop.py`, `src/kodeks/runtime.py` | `read_file_tool_loop`, `unknown_tool_halts_locally`, `live_basic_completion` |
