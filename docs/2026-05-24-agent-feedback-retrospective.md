...
- `pnpm --filter @kodeks/web typecheck`
- `pnpm --filter @kodeks/web lint`
- `pnpm --filter @kodeks/web test`
...
- `pnpm --filter @kodeks/agent-runtime test`
- `pnpm --filter @kodeks/agent-runtime typecheck`
- `pnpm --filter @kodeks/model test`
- `pnpm --filter @kodeks/model typecheck`
- `pnpm --filter @kodeks/web test`
- `pnpm -r typecheck`
- `pnpm -r test`
- `pnpm -r lint`
